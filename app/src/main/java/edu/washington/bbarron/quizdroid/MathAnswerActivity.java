...
public class MathAnswerActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (next == 2) {
                    viewNextActivity = new Intent(MathAnswerActivity.this, MathQ2Activity.class);
                } else if (next == 3) {
                    viewNextActivity = new Intent(MathAnswerActivity.this, MathQ3Activity.class);
                } else if (next == 4) {
                    viewNextActivity = new Intent(MathAnswerActivity.this, MathQ4Activity.class);
                } else if (next == 5) {
                    viewNextActivity = new Intent(MathAnswerActivity.this, MathQ5Activity.class);
                } else {
                    viewNextActivity = new Intent(MathAnswerActivity.this, MainActivity.class);
                    score = 0;
                }
